...
{
    var renderHtml = [];
    renderHtml += '<div class="cls_pageContainer container-fluid col" id="id_pageIndex">'
    ...
    + '					    <div class="row ingredientMapRow">'
    + '						    <div class="col">'
    + '							  	<label for="ingredientCategory">Category</label>'
    ...
    + '						    </div>'
    + '						    <div class="col mt-4">'
    + '						    	<button class="btn btn-success mt-2 cls_addIngredient_sf">Add</button>'
    + '						    </div>'
    + '						    <div class="col">'
    + '						    </div>'
    + '	                    </div>'
...
module.exports.getBaseHtml = getBaseHtml;