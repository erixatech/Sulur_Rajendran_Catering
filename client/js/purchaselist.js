    ...
    if(purchaseListCategory == "Maligai")
    {
        if(cat_maligai && cat_maligai.length>0){
            renderHtml += "<div class='col-12'>"
                        ...
                        +       "<div class='col-3 row'>"
                        +           "<label class='col-form-label col-3'>தேதி</label>"
                        +           "<input type='text' class='form-control cls_sessionDateTime col-7'>"
                        +           "<i class='fa cls_calenderIcon'>&#xf073;</i>"
                        +       "</div>"
                        +       "<div class='col-2 row'>"
                        +           "<select class='form-control cls_pl_session col-11 font-weight-bold' id='id_pl_session' name='plSession'>"
                        +               "<option>காலை </option>"
                        +               "<option>மாலை</option>"
                        +           "</select>"
                        +       "</div>"
                        ...
                        +           "<label class='col-form-label col-4'>மணிக்கு தேவை, இடம்</label>"
                        +           "<input type='text' class='form-control col-3'>"
                        +       "</div>"
                        +   "</div>"
                        + "</div>"
    ...
    if(purchaseListCategory == "PaalThayir")
    {
        renderHtml += "<br><br><div class='row col-12 text-center'>"
                            ...
                            + "<div class='col-12 cls_RowModalOne_Cont'>"
                                + "<div class='col-12 cls_paalThayir_RowModalOne mb-3'>" 
                                    ...
                                    +       "<label class='col-3'>மணிக்கு</label>"
                                    +   "</div>"
                                    +   "<div class='col-3 row'>"
                                    +       "<label class='col-3'>பால் </label>"
                                    +       "<input type='text' class='form-control col-5'>"
                                    +       "<label class='col-3'>லிட்டர்</label>"
                            ...
                            + "<div class='col-12 text-center text-danger font-weight-bold'><u>அரோமா ஸ்பெஷல் பாக்கெட் பால் ஆர்டர் செய்யவும்</u></div><br>"
                                ...
                                + "<div class='col-12 cls_RowModalTwo_Cont'>"
                                    + "<div class='col-12 cls_paalThayir_RowModalTwo mb-3'>"
                                        + "<div class='row text-center font-weight-bold'>"
                                        +   "<div class='col-1'></div>"
                                        +   "<div class='col-3 row'>"
                                        +       "<label class='col-form-label col-3'> தேதி </label>"
                                        ...
                                        +       "<label class='col-6'>மணிக்கு</label>"
                                        +   "</div>"
                                        +   "<div class='col-4 row'>"
                                        +       "<select class='form-control cls_pl_paal_thayir font-weight-bold col-4 mx-3' id='id_pl_session' name='plPaalThayir'>"
                                        +           "<option>பால்</option>"
                                        +           "<option>தயிர்</option>"
                                        +       "</select>"
                                        +       "<input type='text' class='form-control col-4'>"
                                        +       "<label class='col-2'>லிட்டர்</label>"
                                        +       "<span class='col-1 p-0 m-0'> <i class='fa fa-minus-circle mt-2 ml-2 cls_removeCurrentIngMap' data-index='1' style='font-size:25px;color:red'></i></span>"
                                        +   "</div>"
                                        + "</div>"
                                    + "</div>"
...
renderPL.prototype.getPaalThayirModelOneRow = function() {
    ...
    renderHtmlMapRow += "<div class='col-12 cls_paalThayir_RowModalOne mb-3'>"
                            + "<div class='row text-center font-weight-bold'>"
                                +   "<div class='col-1'></div>"
                                +   "<div class='col-3 row'>"
                                +       "<label class='col-form-label col-3'> தேதி </label>"
...
renderPL.prototype.getPaalThayirModelTwoRow = function() {
    ...
    renderHtmlMapRow += "<div class='col-12 cls_paalThayir_RowModalTwo mb-3'>"
                        + "<div class='row text-center font-weight-bold'>"
                            +   "<div class='col-1'></div>"
                            +   "<div class='col-3 row'>"
                            +       "<label class='col-form-label col-3'> தேதி </label>"
