...
renderPL.prototype.render = function(plToRender) {
    ...
    if(purchaseListCategory == "Maligai")
    {
        if(cat_maligai && cat_maligai.length>0){
            renderHtml += "<div class='col-12'>"
                        + "<div class='col-12 text-center font-weight-bold ml-4 pl-4'>"
                        +   "<div class='row'>"
                        +       "<div class='col-3 row'>"
                        +           "<label class='col-form-label col-4'>தேதி</label>"
                        +           "<input type='text' class='form-control cls_sessionDateTime col-8'>"
                        +           "<i class='fa cls_calenderIcon'>&#xf073;</i>"
                        +       "</div>"
                        +       "<div class='col-2 row pr-4'>"
                        +           "<select class='form-control cls_pl_session col-11 font-weight-bold ml-2' id='id_pl_session' name='plSession'>"
                        +               "<option>காலை </option>"
                        +               "<option>மாலை</option>"
                        +           "</select>"
                        +       "</div>"
                        ...
                        +           "<label class='col-form-label col-5 text-center'>மணிக்கு தேவை, இடம்</label>"
    ...
    if(purchaseListCategory == "PaalThayir")
    {
        renderHtml += "<br><br><div class='row col-12 text-center'>"
                            ...
                            + "<div class='col-12 cls_RowModalOne_Cont'>"
                                + "<div class='col-12 cls_paalThayir_RowModalOne font-weight-bold mb-3'>" 
                                    + "<div class='row text-center font-weight-bold'>"
                                    +   "<div class='col-1'></div>"
                                    +   "<div class='col-3 row'>"
                                    +       "<label class='col-form-label col-4'> தேதி </label>"
                                    +       "<input type='text' class='form-control col-7 cls_sessionDateTime'>"
                                    +       "<i class='fa cls_calenderIcon'>&#xf073;</i>"
                                    +   "</div>"
                                    +   "<div class='col-2 row'>"
                                    +       "<select class='form-control cls_pl_session font-weight-bold col-10' id='id_pl_session' name='plSession' >"
                                    +           "<option>காலை </option>"
                                    +           "<option>மாலை</option>"
                                    +       "</select>"
                                    +   "</div>"
                                    +   "<div class='col-2 row'>"
                                    +       "<input type='text' class='form-control col-6'>"
                                    +       "<label class='col-3 pt-1'>மணிக்கு</label>"
                                    +   "</div>"
                                    +   "<div class='col-4 row'>"
                                    +       "<label class='col-4 text-right pt-1'>பால் </label>"
                                    +       "<input type='text' class='form-control col-3'>"
                                    +       "<label class='col-4 pt-1'>லிட்டர்</label>"
                            ...
                            + "<div class='col-12 text-center text-danger font-weight-bold'><u>அரோமா ஸ்பெஷல் பாக்கெட் பால் ஆர்டர் செய்யவும்</u></div><br>"
                                ...
                                + "<div class='col-12 cls_RowModalTwo_Cont'>"
                                    + "<div class='col-12 cls_paalThayir_RowModalTwo font-weight-bold mb-3'>"
                                        + "<div class='row text-center font-weight-bold'>"
                                        +   "<div class='col-1'></div>"
                                        +   "<div class='col-3 row'>"
                                        +       "<label class='col-form-label col-4'> தேதி </label>"
                                        ...
                                        +       "<label class='col-7 pt-1'>மணிக்கு</label>"
                                        +   "</div>"
                                        +   "<div class='col-4 row'>"
                                        +       "<select class='form-control cls_pl_paal_thayir font-weight-bold col-4 mx-4' id='id_pl_session' name='plPaalThayir'>"
                                        +           "<option>பால்</option>"
                                        +           "<option>தயிர்</option>"
                                        +       "</select>"
                                        +       "<input type='text' class='form-control col-3'>"
                                        +       "<label class='col-2 pt-1'>லிட்டர்</label>"
                                        +       "<span class='col-1 p-0 m-0'> <i class='fa fa-minus-circle mt-2 ml-2 cls_removeCurrentIngMap' data-index='1' style='font-size:25px;color:red'></i></span>"
                                        +   "</div>"
                                        + "</div>"
                                    + "</div>"
...
renderPL.prototype.getPaalThayirModelOneRow = function() {
    ...
    renderHtmlMapRow += "<div class='col-12 cls_paalThayir_RowModalOne font-weight-bold mb-3'>" 
                            + "<div class='row text-center font-weight-bold'>"
                            +   "<div class='col-1'></div>"
                            +   "<div class='col-3 row'>"
                            +       "<label class='col-form-label col-4'> தேதி </label>"
                            +       "<input type='text' class='form-control col-7 cls_sessionDateTime font-weight-bold'>"
                            +       "<i class='fa cls_calenderIcon'>&#xf073;</i>"
                            +   "</div>"
                            +   "<div class='col-2 row'>"
                            +       "<select class='form-control cls_pl_session font-weight-bold col-10' id='id_pl_session' name='plSession' >"
                            ...
                            +   "</div>"
                            +   "<div class='col-2 row'>"
                            +       "<input type='text' class='form-control col-6 font-weight-bold'>"
                            +       "<label class='col-3 pt-1'>மணிக்கு</label>"
                            +   "</div>"
                            +   "<div class='col-4 row'>"
                            +       "<label class='col-4 text-right pt-1'>பால் </label>"
                            +       "<input type='text' class='form-control col-3 font-weight-bold'>"
                            +       "<label class='col-4 pt-1'>லிட்டர்</label>"
                            +       "<span class='col-1 p-0 m-0'> <i class='fa fa-minus-circle mt-2 ml-2 cls_removeCurrentIngMap' data-index='1' style='font-size:25px;color:red'></i></span>"
                            +   "</div>"
                            + "</div>"
...
renderPL.prototype.getPaalThayirModelTwoRow = function() {
    ...
    renderHtmlMapRow += "<div class='col-12 cls_paalThayir_RowModalTwo font-weight-bold mb-3'>"
                            + "<div class='row text-center font-weight-bold'>"
                            +   "<div class='col-1'></div>"
                            +   "<div class='col-3 row'>"
                            +       "<label class='col-form-label col-4'> தேதி </label>"
                            ...
                            +   "</div>"
                            +   "<div class='col-2 row'>"
                            +       "<input type='text' class='form-control col-5 font-weight-bold'>"
                            +       "<label class='col-7 pt-1'>மணிக்கு</label>"
                            +   "</div>"
                            +   "<div class='col-4 row'>"
                            +       "<select class='form-control cls_pl_paal_thayir font-weight-bold col-4 mx-4' id='id_pl_session' name='plPaalThayir'>"
